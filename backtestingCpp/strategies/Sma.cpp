...
// Using char* instead of <string> because we would
// port the following strategy into Python and we can 
// use C instead of C++ for this purpose.
...
// This is same as calling function from main.cpp but with Python we have to
// initialize the function to be called (C interface between C++ and Python).
